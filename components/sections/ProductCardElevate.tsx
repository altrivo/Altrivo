...
export default function ProductCardElevate({
  id,
  name,
  price,
  originalPrice,
  ...
  return (
    <div
      className="group relative flex flex-col w-full bg-white rounded-2xl border border-slate-100 overflow-hidden cursor-pointer select-none transition-all duration-200 ease-out hover:-translate-y-1.5 hover:border-slate-200/80 shadow-[0_2px_4px_rgba(0,0,0,0.05)] hover:shadow-[0_12px_24px_rgba(0,0,0,0.12)]"
    >
