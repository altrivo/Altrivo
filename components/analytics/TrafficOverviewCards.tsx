...
export function TrafficOverviewCards({ overview, loading }: TrafficOverviewCardsProps) {
  if (loading) {
    return (
  ...
  const cards = [
    {
      ...
      icon: Eye,
      trend: "up" as const,
      sparkline: [12000, 14500, 16000, 15200, 17800, 19100, 21500],
    ...
    },
    {
      ...
      icon: Users,
      trend: "up" as const,
      sparkline: [8500, 9200, 10100, 9800, 11200, 12000, 13400],
    ...
    },
    {
      ...
      icon: Clock,
      trend: "up" as const,
      sparkline: [2.8, 3.0, 3.1, 3.2, 3.4, 3.5, 3.7],
    ...
    },
    {
      ...
      sparkline: [38.2, 37.0, 36.1, 35.4, 34.2, 33.0, 32.4],
